...
__decorate(
  [(0, type_graphql_1.Field)(() => [TypeGraphQL.Pick]), __metadata('design:type', Array)],
  PicksByWeekResponse.prototype,
  'picks',
  void 0
);
__decorate(
  [(0, type_graphql_1.Field)(() => [TypeGraphQL.Game]), __metadata('design:type', Array)],
  PicksByWeekResponse.prototype,
  'games',
  void 0
);
PicksByWeekResponse = __decorate([(0, type_graphql_1.ObjectType)()], PicksByWeekResponse);
...
__decorate(
  [
    ...
    __param(
      0,
      (0, type_graphql_1.Arg)('league_id', () => type_graphql_1.Int)
    ),
    __param(
      1,
      (0, type_graphql_1.Arg)('week', () => type_graphql_1.Int, {nullable: true})
    ),
