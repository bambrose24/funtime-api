...
WeekWinner = __decorate([(0, type_graphql_1.ObjectType)()], WeekWinner);
...
__decorate(
  [
    ...
    __param(
      1,
      (0, type_graphql_1.Arg)('season', () => type_graphql_1.Int, {nullable: true})
    ),
    __param(
      2,
      (0, type_graphql_1.Arg)('weeks', () => [type_graphql_1.Int], {nullable: true})
    ),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [Number, Object, Object]),
    __metadata('design:returntype', Promise),
  ],
  WeekWinnersResolver.prototype,
  'weekWinners',
  null
);
