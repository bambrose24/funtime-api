...
__decorate([
    (0, type_graphql_1.Field)(),
    __metadata("design:type", Boolean)
], GamePick.prototype, "is_random", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => type_graphql_1.Int, { nullable: true }),
    __metadata("design:type", Number)
], GamePick.prototype, "score", void 0);
GamePick = __decorate([
...
__decorate([
    ...
    __param(0, (0, type_graphql_1.Arg)("member_id", () => type_graphql_1.Int)),
    __param(1, (0, type_graphql_1.Arg)("picks", () => [GamePick])),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Array]),
    __metadata("design:returntype", Promise)
], MakePicksResolver.prototype, "makePicks", null);
MakePicksResolver = __decorate([
...
async function upsertWeekPicksForMember(member_id, picks) {
    ...
    const submissionWeeksAndSeasons = games.reduce((acc, curr) => acc.add(`${curr.week},${curr.season}`), new Set());
