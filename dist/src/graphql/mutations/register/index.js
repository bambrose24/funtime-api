...
__decorate(
  [(0, type_graphql_1.Field)(() => TypeGraphQL.LeagueMember), __metadata('design:type', Object)],
  RegisterResponse.prototype,
  'membership',
  void 0
);
RegisterResponse = __decorate([(0, type_graphql_1.ObjectType)()], RegisterResponse);
let RegisterResolver = class RegisterResolver {
  async register(email, username, previousUserId, superbowlWinner, superbowlLoser, superbowlScore) {
    ...
    try {
      await (0, email_1.sendRegistrationMail)(
        user,
        exports.SEASON,
        superbowlWinner,
        superbowlLoser,
...
__decorate(
  [
    ...
    __param(
      2,
      (0, type_graphql_1.Arg)('previousUserId', () => type_graphql_1.Int, {nullable: true})
    ),
    __param(
      3,
      (0, type_graphql_1.Arg)('superbowlWinner', () => type_graphql_1.Int)
    ),
    __param(
      4,
      (0, type_graphql_1.Arg)('superbowlLoser', () => type_graphql_1.Int)
    ),
    __param(
      5,
      (0, type_graphql_1.Arg)('superbowlScore', () => type_graphql_1.Int)
    ),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [String, String, Object, Number, Number, Number]),
    __metadata('design:returntype', Promise),
  ],
  RegisterResolver.prototype,
  'register',
  null
);
RegisterResolver = __decorate([(0, type_graphql_1.Resolver)()], RegisterResolver);
